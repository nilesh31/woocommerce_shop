...
<div id="reviews" class="woocommerce-Reviews">
    ...
    <div id="woocommerce_dispaly_reviews"><button id="button-review" class="b1" onclick="woocommerce_Reviews()">Comments</button></div>
		...
		<div id="review_form_wrapper">
			<div id="review_form">
				<?php
					...
					$comment_form['comment_field'] .= '<p class="comment-form-comment"><label for="comment">' . esc_html__( 'Your review', 'woocommerce' ) . ' <span class="required">*</span></label><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" required placeholder="Write Comments..." ></textarea></p>';
